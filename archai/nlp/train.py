...
def parse_args():
    parent_parser = argparse.ArgumentParser(
        description='PyTorch GPT2', ##############change to model name
    ...
    if config_args.config is not None and config_args.config_file is not None:
        config_file_path = utils.full_path(os.path.join('./content/drive/Shareddrives/ECE 226 Project/archai-neurips-lts/archai-neurips-lts/', 'archai', 'nlp', config_args.config_file))
    ...
    general.add_argument('--work_dir', default='/content/drive/Shareddrives/ECE 226 Project/archai-neurips-lts/archai-neurips-lts/logdir', type=str,
    ...
    training.add_argument('--max_step', type=int, default=1,
