...
class HfGPT(ArchaiModel):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.config = HfGPTConfig(**kwargs)
        self.model = OpenAIGPTLMHeadModel(self.config)
    ...
    def get_params(self) -> Dict[str, int]:
        ...
        params['attention'] = self.get_params_from_layer(['GPTAttention'])
        params['ff'] = self.get_params_from_layer(['GPTMLP'])
